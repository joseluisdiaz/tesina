...
\begin{description}
 ...
 \item $CommSend.mailboxId.params$  El primer parámetro es cualquier $mailboxId$ y representa el mailbox destino. El segundo parámetro, es una lista. $CommRecv.mailboxId.params$ se interpreta de la misma forma.
 \end{description}
